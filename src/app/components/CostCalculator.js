...
const CostCalculateModal = ({ open, onClose, title = "Cost Calculation", children }) => {
    ...
    return (
        ...
        >
            {/* <AppBar sx={{ position: 'relative', backgroundColor: '#418ED6' }}> */}
                            ...
                            {servicesList.map((item, idx) => {
                                ...
                                return (
                                    <Col key={idx} xs={3} sm={4} md={3} lg={3}>
                                        ...
                                        <div
                                            className={` rounded-4 d-flex align-items-center justify-content-center flex-column p-3 h-100 shadow-sm ${isSelected ? "border" : "border"
                                                }`}
                                            style={{
                                                minHeight: "120px",
                                                cursor: "pointer",
                ...
                {step === 7 && (
                    <div className="text-center py-5">
                        ...
                        <p className="text-muted mb-4 " >
                            We'll get back to you within 1 business day <br />with a response
          ...
          variant="determinate"
          value={(step / 7) * 100}
          sx={{ height: 10, borderRadius: 5, mb: 4,mt:4 }}
        />
        <div className="d-flex justify-content-between mt-5">
              <Button
                variant="outlined"
